...
if __name__ == '__main__':
    ...
    kd_crop = (6.25, 4.76, 2.05, 1.45)
    td_crop = (6.25, 4.76, 1.22, 1.03)
    tt_crop = (4.5, 3.97, 2.55, 1.18)
    for file in listdir(directory):
        try:
            ...
            name = f'{kd_deno} ({td_deno}) {td_name}.pdf'
            rename(path.join(directory, file), path.join(directory_result, name))
        except:
            pass
